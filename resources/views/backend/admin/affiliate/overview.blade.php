                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <h4 class="mb-0">{{ formatPrice($user->user_balance, true) }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="d-flex">
                                        <textarea type="text" class="form-control me-3 flex-grow-1" rows="1" id="referral_code_url" readonly>{{ route('register') }}?referral_code={{ $user->referral_code }}</textarea>
        ...
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('admin.affiliate.withdraw.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="amount" class="form-label">
                                {{ localize('Withdrawal Amount') }}
                            ...
                            <x-form.input
                                   ...
                                   max="{{ user()->user_balance }}"
                            />

                            <small>*{{ localize('Minimum Withdrawal Amount: ') }} {{ formatPrice(getSetting('minimum_withdrawal_amount')) }}</small>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <x-form.select class="form-select modalSelect2" id="payout_account_id" name="payout_account_id">
                                <option value="">
