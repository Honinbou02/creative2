...
use App\Http\Middleware\Admin\AuthMenuMiddleware;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'permission' => AuthMenuMiddleware::class,
        'affiliate' => AffiliateMiddleWare::class,
        'isAllowFrontend'=>IsFrontendEnable::class,
        "demo.middleware" => DemoMiddleware::class
    ];
}
