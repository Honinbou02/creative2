...
@section("pagetitle", localize('Speech to Text Report'))
@section('breadcrumb')
    @php
        $breadcrumbItems = [['href' => null, 'title' => localize('Speech to Text Report')]];
    @endphp
                                ...
                                <div class="row justify-content-between g-3">
                                    ...
                                    <div class="col-4">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control form-control-sm date-range-picker date-range"
                                                   type="text"
                                                   id="date_range"
...
@endsection
@section('js')
@include('backend.admin.reports.js.s2t-js')
@endsection