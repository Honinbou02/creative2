...
class SessionLab
{
    ...
    #which ai engine is used
    const SESSION_CONNECT_TYPE         = "session_connect_type";
    ...
    #AI ASSISTANT
    const SESSION_AI_ASSISTANT_PROMPT = "session_ai_assistant_prompt";
    const SESSION_AI_ASSISTANT_CONTENTS = "session_ai_assistant_contents";
    const SESSION_AI_ASSISTANT_GENERATED_CONTENT_ID = "session_ai_assistant_generated_content_id";
