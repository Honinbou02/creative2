...
@endsection
@section("pagetitle", localize('Manage Admins'))

@section('breadcrumb')
@php
    $breadcrumbItems = [
        ["href"  => null, "title" => localize("Admin Users")]
    ];
@endphp
...
@section('pageTitleButtons')
    <div class="col-auto">
        <x-form.button type="button" id="addUserBtnForOffCanvas" data-bs-toggle="offcanvas" data-bs-target="#addUserSideBar"><i data-feather="plus"></i>{{ localize('Add Admin') }}</x-form.button>
    </div>
@endsection
