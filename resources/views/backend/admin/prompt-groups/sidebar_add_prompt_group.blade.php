<form action="{{ route('admin.prompt-groups.store') }}" method="POST" id="addFrm">
    <div class="offcanvas offcanvas-end" id="addFormSidebar" tabindex="-1">
        ...
        <div class="offcanvas-header border-bottom py-3">
            <h5 class="offcanvas-title">{{ localize('Add New Group') }}</h5>
        ...
        <div class="offcanvas-body">
            ...
            <div class="mb-3">
                <x-form.label for="group_name" label="{{ localize('Name') }}" isRequired=true />
                <x-form.input id="group_name" name="group_name"
                              type="text"
