...
class FAQSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $f_a_q_s = array(
            array('id' => '1','question' => 'Where can I learn more about copywriting or entrepreneurship?','answer' => 'WriteRap - is an innovative SaaS platform that harnesses the power of OpenAI Artificial Intelligence technology to provide your users with a range of exceptional features. WriteRap, users can effortlessly generate unique and plagiarism-free content and images, taking advantage of multiple languages for enhanced versatility. It\'s all in one SaaS platform to generate AI content, image and code.','is_active' => '1','user_id' => '1','created_by_id' => '1','updated_by_id' => NULL,'created_at' => '2024-07-08 06:07:45','updated_at' => '2024-07-08 06:07:45','deleted_at' => NULL),
            ...
            array('id' => '5','question' => 'What can I create with WriteRap?','answer' => 'We have copywriting tools for everything you need to start and run your business! You can write blog posts, product descriptions, and even Instagram captions with WriteRap. We\'re always updating our tools, so let us know what else you\'d like to see!','is_active' => '1','user_id' => '1','created_by_id' => '1','updated_by_id' => NULL,'created_at' => '2024-07-08 06:08:56','updated_at' => '2024-07-08 06:08:56','deleted_at' => NULL)
          );
