...
@section('title')
    {{ localize('Support Category') }}{{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
@section("pagetitle", localize('Support Category'))
@section('breadcrumb')
    @php
    $breadcrumbItems = [['href' => null, 'title' => 'Support Category']]; @endphp
...
@section('pageTitleButtons')
    <div class="col-auto">
        <x-form.button type="button" id="addFrmOffCanvas" data-bs-toggle="offcanvas"
            data-bs-target="#addCategoryFormSidebar">
            <i data-feather="plus"></i>{{ localize('Add Support Category') }}
        </x-form.button>
    </div>
@endsection
...
@section('content')
    ...
    @include('backend.admin.support.categories.add-category')
    <!-- Add tag Category -->
@endsection
@section('js')
    @include('backend.admin.support.categories.js')
@endsection
