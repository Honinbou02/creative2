            ...
            <div class="row g-3">
                <div class="col-auto flex-grow-1">
                    <div class="tt-page-title">
                        <h1 class="h4 mb-lg-1">SEO Optimization</h1>
                        <nav>
                            <ol class="breadcrumb tt-breadcrumb-dot">
                                <li class="breadcrumb-item"><a href="#" class="text-body">AI Article</a></li>
                ...
                <div class="col-auto">
                    <div class="d-flex align-items-center flex-column bg-light-subtle px-3 py-2 rounded">
                        <div class="d-flex justify-content-between w-100 fs-md lh-1 mb-2">
                            <span>Total: <strong>5k</strong></span>
                            <span class="ms-4">Remaining Balance:
                                <strong>2000</strong></span>
                        </div>
                ...
                <div class="col-auto">
                    <div class="dropdown tt-tb-dropdown">
                        <a class="btn btn-light" id="navbarDropdownUser" href="#!" role="button"
