...
@section('title')
    {{ localize('Prompts Lists') }} {{ getSetting('tab_separator') }} {{ getSetting('system_title') }}
@endsection
@section("pagetitle", localize('Prompt'))

@section('breadcrumb') @php
    $breadcrumbItems = [
        ["href"  => null, "title" => "Prompts"]
    ]; @endphp
...
@section('pageTitleButtons')
    <div class="col-auto">
        <x-form.button type="button"
            ...
            <i data-feather="plus"></i>{{ localize("Add Prompt") }}
        </x-form.button>
    </div>
@endsection
...
@section('content')
    ...
    <!-- Add Prompt start-->
    @include('backend.admin.prompts.sidebar_add_prompt')
    <!-- Add Prompt -->

@endsection
@section('js')
    @include('backend.admin.prompts.js')
@endsection
