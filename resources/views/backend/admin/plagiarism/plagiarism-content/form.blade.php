...
@section('title')
{{ localize('AI Plagiarism') }} {{ getSetting('tab_separator') }} {{ getSetting('system_title') }}
@endsection
...
@section('breadcrumb')
    @php
        $breadcrumbItems = [['href' => null, 'title' => localize('AI Plagiarism')]];
    @endphp
...
@section('pageTitleButtons')
    <div class="col-auto">
        ...
        <a href="{{route('admin.documents.index', ['content_purpose'=>appStatic()::PURPOSE_CONTENT_PLAGIARISM])}}" class="btn btn-primary btn-sm"><i class="las la-plus me-1"></i>{{ localize('All Content') }}</a>
    </div>
@endsection
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card content-generator flex-md-row">
                            ...
                            <div class="content-generator__sidebar">
                                <form action="{{ route('admin.ai-plagiarism.store') }}" method="POST" id="plagiarismScanContent">
                                    @csrf
                                    <x-form.input type="hidden" name="content_purpose" value="{{appStatic()::PURPOSE_CONTENT_PLAGIARISM}}"/>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <x-form.textarea name="text" class="form-control" id="textarea" rows="30" />
                                                </div>
                            ...
                            <div class="content-generator__body">
                                <div class="tt-generate-text" id="renderChat">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card flex-column h-100 rounded-0 border-0 border-bottom">
...
@endsection
@section('js')
    @include('backend.admin.plagiarism.plagiarism-content.js')
@endsection
