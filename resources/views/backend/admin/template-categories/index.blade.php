...
@section('title')
    {{ localize('Template Categories') }} {{ getSetting('tab_separator') }} {{ getSetting('system_title') }}
    @endsection
@section("pagetitle", localize('Template Categories'))

@section('breadcrumb')
    @php
    $breadcrumbItems = [['href' => null, 'title' => 'Template Categories']]; @endphp
    <x-common.breadcumb :items="$breadcrumbItems" />
@endsection

@section('pageTitleButtons')
    <div class="col-auto">
        <x-form.button type="button" id="addTemplateCategoryFormOffCanvas" data-bs-toggle="offcanvas"
            data-bs-target="#addTemplateCategoryFormSidebar">
...
@section('content')
                            ...
                            <table class="table border rounded">
                                <thead>
                                    <tr class="bg-secondary-subtle">
                                        <th>{{ localize('S/L') }}</th>
                                        <th>{{ localize('Template Category') }}</th>
                                        <th>{{ localize('Icon') }}</th>
    ...
    @include('backend.admin.template-categories.sidebar-add-template-category')
    <!-- Add Template Category -->
@endsection
@section('js')
    @include('backend.admin.template-categories.js')
@endsection
