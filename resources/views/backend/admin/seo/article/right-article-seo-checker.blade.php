<div class="content-generator__sidebar content-generator__sidebar--end order-1 oreder-md-2">
    ...
    <div class="content-generator__sidebar-body tt-custom-scrollbar overflow-y-auto tt-screen-height">
        <div class="row g-3">
            <div class="col-12 mt-1">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="w-100">
                            <div class="row g-3 meeterSectionReport">
            ...
            <div class="col-12">
                <div class="tt-custom-scrollbar overflow-y-auto overflow-x-hidden seoFeedBacks"> 
    ...
    <div class="content-generator__sidebar-footer d-flex align-items-center mt-3">
        <button class="btn btn-sm btn-primary rounded-pill articleSeoCheckerBtn">
