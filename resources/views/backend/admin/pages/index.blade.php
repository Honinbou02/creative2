...
@section('title')
    {{ localize('Pages') }} {{ getSetting('tab_separator') }} {{ getSetting('system_title') }}
@endsection
@section("pagetitle", localize('Pages'))
@section('breadcrumb')
    @php
    $breadcrumbItems = [['href' => null, 'title' => 'Pages']]; @endphp
    <x-common.breadcumb :items="$breadcrumbItems" />
@endsection

@section('pageTitleButtons')
    <div class="col-auto">
        <x-form.button type="button" id="addPageFormOffCanvas" data-bs-toggle="offcanvas"
            data-bs-target="#addPageFormSidebar">
            <i data-feather="plus"></i>{{ localize('Add Page') }}
        </x-form.button>
    </div>
@endsection
...
@section('content')
    ...
    @include('backend.admin.pages.add-page')
    <!-- Add tag Category -->
@endsection
@push('scripts')
...
@endpush
@section('js')
    @include('backend.admin.pages.js')
@endsection
